...
const Profile = () => {
    ...
    return (
        <div>
            <div className="flex flex-col justify-center max-w-xs p-6 shadow-md mx-auto my-72 rounded-xl sm:px-12 bg-neutral dark:text-gray-100">
                ...
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    ...
                    <div className="flex justify-center pt-2 space-x-4 align-center">
                        ...
                        <Link rel="noopener noreferrer" to="#" aria-label="Dribble" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                        ...
                        <Link rel="noopener noreferrer" to="#" aria-label="Email" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
